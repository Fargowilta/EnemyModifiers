...
//        {
//            if (++counter > Main.rand.Next(600) + 60)
//            {
//                aiStyle = npc.aiStyle;
...
//                        npc.noTileCollide = true;
//                        npc.noGravity = true;
//                        break; //nebula floater
//                    case 15:
//                        npc.aiStyle = 86;
//                        npc.noTileCollide = true;
//                        npc.noGravity = true;
//                        break; //ancient vision
//                    case 16:
//                        npc.aiStyle = 87;
//                        npc.noTileCollide = false;
//                        npc.noGravity = false;
...
//                    npc.Center = Main.player[npc.target].Center + Main.rand.NextFloat(2f) *
//                        npc.Distance(Main.player[npc.target].Center) * Vector2.UnitX.RotatedByRandom(MathHelper.TwoPi);
...
//                            baseRotation.ToRotationVector2().RotatedBy(Math.PI * 2 / max * i) * speed, type,
//                            npc.damage / 4, 0, Main.myPlayer);
//                    }
//                }
//            }
